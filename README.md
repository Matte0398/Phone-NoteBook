...
The `examples/` directory contains sample output generated using fictional
contacts:

- [Sample CSV](examples/NoteBook.csv): two contacts, with and without a description.
- [Sample log](examples/NoteBook.log): the corresponding add and search operations.

The sample files were generated by running these commands from `examples/`:
